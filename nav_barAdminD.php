  ...
  <div class="top-menu">
    <ul class="nav pull-right">
      ...
      <li style="display: inline-block;">
        <form class="form-inline" role="search" method="post" action="DoctorAdmin_Details.php">
          <div style="font-family: 'Figtree', sans-serif;font-size: 14px;">
            <label for="">Search Doctor:</label>
            <input type="text" name="doctor_id" id="text" class="form-control" placeholder="User ID">
