...
$query = "SELECT patient_id, patient_name, patient_IC, patient_age, patient_gender, patient_address, patient_phone, 
                 patient_email, patient_password, event_dt, patient_reports, patient_guardianP FROM tbl_patients WHERE patient_IC = '$patient_IC'";
...
<div class="text-center">
      <a href="PesakitStaff_Update.php?edit=<?php echo $patient['patient_IC']; ?>" class="btn btn-success" role="button"> Edit </a>
