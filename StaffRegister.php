...
<?php 
    ...
    {
        header("Location:Staff_Search.php");
        exit();
    }
        ...
        WHERE staff_IC LIKE staff_IC 
        ORDER BY `staff_IC` DESC LIMIT 1";
  ...
  <section id="container">
    ...
    <div style="font-family: 'Figtree', sans-serif;font-size: 16px;">
      <div class="page-header">
        <center><h2>Masukkan Staff Baharu</h2></center>
      </div>
    <form action="StaffRegister.php" method="post" class="form-horizontal">
      <div class="form-group">
          <label for="staffid" class="col-sm-3 control-label">ID</label>
          <div class="col-sm-9">
         <input name="staff_id" type="text" class="form-control" id="staffid" placeholder="Staff ID" value="<?php if(isset($_GET['edit'])) echo $editrow['staff_id']; ?>" required>
        </div>
        </div>
      <div class="form-group">
          <label for="staffname" class="col-sm-3 control-label">Nama Penuh</label>
          <div class="col-sm-9">
          <input name="staff_name" type="text" class="form-control" id="staffname" placeholder="Nama" value="<?php if(isset($_GET['edit'])) echo $editrow['staff_name']; ?>" required>
        </div>
        </div>
        <div class="form-group">
          <label for="staffic" class="col-sm-3 control-label">IC</label>
          <div class="col-sm-9">
          <input name="staff_IC" type="text" class="form-control" id="staffic" placeholder="IC" value="<?php if(isset($_GET['edit'])) echo $editrow['staff_IC']; ?>" required>
        </div>
        </div>
        <div class="form-group">
          ...
          <div class="radio">
            <label>
              <input name="staff_gender" type="radio" id="staffgender" value="Perempuan" <?php if(isset($_GET['edit'])) if($editrow['staff_gender']=="Perempuan") echo "checked"; ?>required> Perempuan
            </label>
            </div>   
          </div>
      </div>
      <div class="form-group">
        ...
        <div class="form-group">
          <label for="staffposition" class="col-sm-3 control-label">Jawatan</label>
          <div class="col-sm-9">
          <input name="staff_position" type="text" class="form-control" id="staffposition" placeholder="Staff" value="<?php if(isset($_GET['edit'])) echo $editrow['staff_position']; ?>" required>
        </div>
        </div>
        <div class="form-group">
          <label for="staffgred" class="col-sm-3 control-label">Gred</label>
          <div class="col-sm-9">
          <input name="staff_gred" type="text" class="form-control" id="staffgred" placeholder="Gred" value="<?php if(isset($_GET['edit'])) echo $editrow['staff_gred']; ?>" required>
        </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="staff_repassword" type="text" class="form-control" id="staffrepassword" placeholder="Retype Password" value="<?php if(isset($_GET['edit'])) echo $editrow['staff_repassword']; ?>" required>
        </div>
        </div>
