  ...
  <section id="container">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header">
        <center><h2>Kemaskini Maklumat Pesakit</h2></center>
      </div>
    <form action="PesakitStaff_Update.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <textarea name="patient_reports" type="text" class="form-control" rows="12" id="reports" ><?php if(isset($_GET['edit'])) echo $editrow['patient_reports']; ?></textarea>
        </div>
        </div>
