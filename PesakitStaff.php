  ...
  <section id="container">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <div class="page-header">
        <center><h2>Daftar Pesakit Baharu</h2></center>
      </div>
    <form action="PesakitStaff.php" method="post" class="form-horizontal">
      <div class="form-group">
          <label for="patientid" class="col-sm-3 control-label">ID</label>
          <div class="col-sm-9">
         <input name="patient_id" type="text" class="form-control" id="patientid" placeholder="Pesakit ID" value="<?php if(isset($_GET['edit'])) echo $editrow['patient_id']; ?>" required>
        </div>
        </div>
      <div class="form-group">
          <label for="patientname" class="col-sm-3 control-label">Nama Penuh</label>
          <div class="col-sm-9">
          <input name="patient_name" type="text" class="form-control" id="patientname" placeholder="Nama" value="<?php if(isset($_GET['edit'])) echo $editrow['patient_name']; ?>" required>
        </div>
        </div>
        <div class="form-group">
          <label for="patientic" class="col-sm-3 control-label">IC</label>
          <div class="col-sm-9">
          <input name="patient_IC" type="text" class="form-control" id="patientic" placeholder="IC" value="<?php if(isset($_GET['edit'])) echo $editrow['patient_IC']; ?>" required>
        </div>
        </div>
        <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <textarea name="patient_reports" class="form-control" rows="12" id="reports" ><?php if(isset($_GET['edit'])) echo $editrow['patient_reports']; ?></textarea>
        </div>
        </div>
         ...
         <button class="btn btn-default" type="submit" name="update"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Update</button>
          ...
          <?php } ?>
          <a href="viewAppointmentPatient.php" class="btn btn-default" role="button">Back</a>
        </div>
      </div>
    </form>
    </div>
