  ...
  <section id="container">
    ...
    <div style="font-family: 'Figtree', sans-serif;font-size: 16px;">
      <div class="page-header">
        <center><h2>Masukkan Doctor Baharu</h2></center>
      </div>
    <form action="StaffRegister.php" method="post" class="form-horizontal">
      <div class="form-group">
          ...
          <div class="col-sm-9">
         <input name="doctor_id" type="text" class="form-control" id="doctorid" placeholder="Doctor ID" value="<?php if(isset($_GET['edit'])) echo $editrow['doctor_id']; ?>" required>
        </div>
        </div>
      <div class="form-group">
          <label for="drname" class="col-sm-3 control-label">Nama Penuh</label>
          <div class="col-sm-9">
          <input name="dr_name" type="text" class="form-control" id="drname" placeholder="Nama" value="<?php if(isset($_GET['edit'])) echo $editrow['dr_name']; ?>" required>
        </div>
        </div>
        <div class="form-group">
          <label for="dric" class="col-sm-3 control-label">IC</label>
          <div class="col-sm-9">
          <input name="dr_IC" type="text" class="form-control" id="dric" placeholder="IC" value="<?php if(isset($_GET['edit'])) echo $editrow['dr_IC']; ?>" required>
        </div>
        </div>
        <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          <label for="drrepassword" class="col-sm-3 control-label">Retype Password</label>
          <div class="col-sm-9">
          <input name="dr_repassword" type="text" class="form-control" id="drrepassword" placeholder="Retype Password" value="<?php if(isset($_GET['edit'])) echo $editrow['dr_repassword']; ?>" required>
        </div>
        </div>
